...
public class AutoFishAffix extends Affix {

    public static final Codec<AutoFishAffix> CODEC = RecordCodecBuilder.create(inst -> inst
            .group(GemBonus.VALUES_CODEC.fieldOf("values").forGetter(a -> a.values))
            .apply(inst, AutoFishAffix::new));

    protected final Map<LootRarity, StepFunction> values;

    public AutoFishAffix(Map<LootRarity, StepFunction> values) {

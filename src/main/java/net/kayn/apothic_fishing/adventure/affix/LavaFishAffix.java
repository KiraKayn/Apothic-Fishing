...
public class LavaFishAffix extends Affix {

    public static final Codec<LavaFishAffix> CODEC = RecordCodecBuilder.create(inst -> inst
            .group(GemBonus.VALUES_CODEC.fieldOf("values").forGetter(a -> a.values))
            .apply(inst, LavaFishAffix::new));

    protected final Map<LootRarity, StepFunction> values;

    public LavaFishAffix(Map<LootRarity, StepFunction> values) {
